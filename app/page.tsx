...
import { ArrowRight, ArrowLeft, Sparkles, Loader2, Video, FileText, Wand2, Play, Pause, User, Image, Gamepad2, Volume2, Check, Laugh, Zap, Ghost, BookOpen, MessageCircle, Heart, Clock, DollarSign } from "lucide-react";
...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-background text-foreground flex flex-col">
      <Navbar onLogoClick={() => { setShowForm(false); resetWizard(); }} />
      ...
      <main className="flex-1 flex flex-col items-center justify-center text-center px-4 py-12 sm:py-20">
        {!showForm ? (
          ...
          // Multi-step Wizard
          <div className="max-w-2xl w-full bg-white dark:bg-zinc-900 p-8 rounded-2xl border border-zinc-200 dark:border-zinc-800 shadow-2xl">
            {!videoUrl ? (
              <>
                {/* Header */}
                <div className="text-center space-y-2 mb-8">
