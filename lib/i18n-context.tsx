...
export const translations = {
  en: {
    ...
    steps: {
      ...
      chooseBackgroundVideo: "Choose Background Video",
      chooseBackgroundVideoDesc: "Select the background video for your gameplay video",
    ...
    messages: {
      ...
      seriesNameRequired: "Please enter a series name",
      selectOnePlatform: "Please select at least one publishing platform",
      tiktokPrivacyRequired: "Please select a TikTok privacy level to continue",
      starterPlanThreeDays: "Starter plan requires selecting exactly 3 publish days per week.",
      eliteSecondPublishTime: "Please select a second publish time for your Elite plan.",
      seriesCreatedSuccess: "Series \"{{name}}\" created successfully!",
      noVideoToPost: "No video to post",
      signInFirst: "Please sign in first",
      connectAccountFirst: "Please connect your {{platform}} account first in the Social Media section",
      postingHandledAutomatically: "Posting to {{platform}} is now handled automatically by the system. Your video will be posted at the scheduled time.",
      socialConnectionVerifyFailed: "Failed to verify social media connection",
      starterPlanDeselectDay: "Starter plan allows exactly 3 days per week. Deselect another day first.",
      connectionFailed: "Connection failed",
      unknownError: "Unknown error occurred",
      oauthErrorFormat: "Error: {{error}}",
      oauthErrors: {
        missing_params: "OAuth parameters missing",
        oauth_failed: "Failed to connect to social media",
        access_denied: "You denied access",
        publish_scope_required: "You must allow posting permission to connect. Please try again and enable posting when asked.",
      },
      cancel: "Cancel",
    },
    // Errors
    ...
    dashboard: {
      menu: {
        ...
        manageSeries: "Manage Series",
        scheduledVideos: "Library",
        subscription: "My Subscription",
      },
      scheduledPosts: {
        title: "Library",
        subtitle: "View and manage your pending video posts.",
        loading: "Loading scheduled videos...",
        empty: "No scheduled videos. Your pending posts will appear here.",
        download: "Download",
        cancel: "Cancel",
        delete: "Delete",
        ...
        youtubeOnlyBadge: "YouTube Only",
        descriptionLabel: "Description",
        hashtagsLabel: "Hashtags",
        cancelConfirmTitle: "Cancel scheduled post?",
        cancelConfirmMessage: "Are you sure you want to cancel this scheduled post? This cannot be undone.",
        ...
        publishFailed: "Failed to publish video",
        musicUsageConsentPrefix: "By posting, you agree to TikTok's ",
        musicUsageConsentLink: "Music Usage Confirmation",
        musicUsageConsentSuffix: ".",
        processingNotice: "After publishing, it may take a few minutes for your content to process and become visible on your profile.",
        tiktokStatusUploading: "Uploading video...",
        tiktokStatusUploadDesc: "Sending your video to the platform. This may take a minute...",
        tiktokStatusProcessing: "Publishing to TikTok...",
        tiktokStatusUpload: "Uploading your video to TikTok...",
        tiktokStatusDownload: "TikTok is downloading your video...",
        tiktokStatusInbox: "Video sent to your TikTok inbox.",
        tiktokStatusWaiting: "Waiting for TikTok to process...",
        tiktokStatusComplete: "Published to TikTok!",
        tiktokStatusCompleteDesc: "Your video is now live on TikTok.",
        tiktokStatusFailed: "Publishing Failed",
        tiktokStatusFailedDesc: "An error occurred while publishing your video.",
        tiktokStatusFailedReason: "Reason",
        tiktokStatusDone: "Done",
        tiktokStatusClose: "Close",
      },
      subscription: {
      ...
      socialMedia: {
        ...
        disconnectErrorTitle: "{platform} disconnect failed",
        connectSuccessTitle: "{platform} connected",
        disconnectSuccessTitle: "{platform} disconnected",
      ...
      seriesManagement: {
        ...
        never: "Never",
        platforms: "Platforms",
        platformsHint: "Removing all platforms will automatically deactivate the series.",
        videoType: "Video Type",
        ...
        errors: {
          ...
          CANNOT_ACTIVATE_WITHOUT_PLATFORMS: "Cannot activate a series without platforms. Add at least one platform before activating.",
          ...
          PLATFORM_NOT_CONNECTED: "You selected a platform you're not connected to. Connect it in the Social Media section first, then try again.",
      ...
      seriesSetup: {
        ...
        summaryDays: "Days",
        tiktokPrivacyLabel: "TikTok Privacy Level",
        tiktokPrivacyPlaceholder: "Select privacy level...",
        tiktokPrivacyPublic: "Public to Everyone",
        tiktokPrivacyMutualFollowers: "Mutual Followers",
        tiktokPrivacyFollowers: "Followers Only",
  ...
  es: {
    ...
    steps: {
      ...
      chooseBackgroundVideo: "Elegir Video de Fondo",
      chooseBackgroundVideoDesc: "Selecciona el video de fondo para tu video de gameplay",
    ...
    categories: {
      ...
      "life-hacks": "Trucos de Vida",
      mystery: "Misterio",
      psychology: "Datos de Psicología",
      "did-you-know": "Sabías Que",
      animals: "Datos de Animales",
      riddles: "Acertijos",
    },
    artStyles: {
    ...
    messages: {
      ...
      billingPortalError: "Error al abrir el portal de facturación. Por favor, inténtalo de nuevo.",
      seriesNameRequired: "Por favor, introduce un nombre para la serie",
      selectOnePlatform: "Por favor, selecciona al menos una plataforma de publicación",
      tiktokPrivacyRequired: "Por favor, selecciona un nivel de privacidad de TikTok para continuar",
      starterPlanThreeDays: "El plan Starter requiere seleccionar exactamente 3 días de publicación por semana.",
      eliteSecondPublishTime: "Por favor, selecciona una segunda hora de publicación para tu plan Elite.",
      seriesCreatedSuccess: "¡Serie \"{{name}}\" creada correctamente!",
      noVideoToPost: "No hay video para publicar",
      signInFirst: "Por favor, inicia sesión primero",
      connectAccountFirst: "Conecta tu cuenta de {{platform}} primero en la sección Redes Sociales",
      postingHandledAutomatically: "La publicación en {{platform}} se gestiona automáticamente. Tu video se publicará en el horario programado.",
      socialConnectionVerifyFailed: "Error al verificar la conexión con redes sociales",
      starterPlanDeselectDay: "El plan Starter permite exactamente 3 días por semana. Desmarca otro día primero.",
      connectionFailed: "Error de conexión",
      unknownError: "Error desconocido",
      oauthErrorFormat: "Error: {{error}}",
      oauthErrors: {
        missing_params: "Faltan parámetros de OAuth",
        oauth_failed: "Error al conectar con redes sociales",
        access_denied: "Has denegado el acceso",
        publish_scope_required: "Debes permitir el permiso de publicar para conectar. Vuelve a intentarlo y activa la publicación cuando se te pida.",
      },
      cancel: "Cancelar",
    },
    errors: {
    ...
    dashboard: {
      menu: {
        ...
        manageSeries: "Gestionar Series",
        scheduledVideos: "Biblioteca",
        subscription: "Mi Suscripción",
      },
      scheduledPosts: {
        title: "Biblioteca",
        subtitle: "Ver y gestionar tus publicaciones de video pendientes.",
        loading: "Cargando videos programados...",
        empty: "No hay videos programados. Tus publicaciones pendientes aparecerán aquí.",
        download: "Descargar",
        cancel: "Cancelar",
        delete: "Eliminar",
        publishTime: "Hora de publicación",
        platforms: "Plataformas",
        youtubeTitleLabel: "Título",
        youtubeOnlyBadge: "Solo YouTube",
        descriptionLabel: "Descripción",
        hashtagsLabel: "Hashtags",
        cancelConfirmTitle: "¿Cancelar publicación programada?",
        cancelConfirmMessage: "¿Estás seguro de que quieres cancelar esta publicación programada? No se puede deshacer.",
        ...
        publishSuccess: "¡Video publicado exitosamente!",
        publishFailed: "Error al publicar el video",
        musicUsageConsentPrefix: "Al publicar, aceptas la ",
        musicUsageConsentLink: "Confirmación de Uso de Música de TikTok",
        musicUsageConsentSuffix: ".",
        processingNotice: "Después de publicar, tu contenido puede tardar unos minutos en procesarse y ser visible en tu perfil.",
        tiktokStatusUploading: "Subiendo video...",
        tiktokStatusUploadDesc: "Enviando tu video a la plataforma. Esto puede tardar un minuto...",
        tiktokStatusProcessing: "Publicando en TikTok...",
        tiktokStatusUpload: "Subiendo tu video a TikTok...",
        tiktokStatusDownload: "TikTok está descargando tu video...",
        tiktokStatusInbox: "Video enviado a tu bandeja de TikTok.",
        tiktokStatusWaiting: "Esperando que TikTok procese...",
        tiktokStatusComplete: "¡Publicado en TikTok!",
        tiktokStatusCompleteDesc: "Tu video ya está disponible en TikTok.",
        tiktokStatusFailed: "Error al publicar",
        tiktokStatusFailedDesc: "Ocurrió un error al publicar tu video.",
        tiktokStatusFailedReason: "Motivo",
        tiktokStatusDone: "Listo",
        tiktokStatusClose: "Cerrar",
      },
      subscription: {
      ...
      socialMedia: {
        ...
        disconnectErrorTitle: "Error al desconectar {platform}",
        connectSuccessTitle: "{platform} conectado",
        disconnectSuccessTitle: "{platform} desconectado",
      ...
      seriesManagement: {
        ...
        never: "Nunca",
        platforms: "Plataformas",
        platformsHint: "Eliminar todas las plataformas desactivará automáticamente la serie.",
        videoType: "Tipo de Video",
        ...
        errors: {
          ...
          CANNOT_ACTIVATE_WITHOUT_PLATFORMS: "No se puede activar una serie sin plataformas. Agrega al menos una plataforma antes de activar.",
          ...
          PLATFORM_NOT_CONNECTED: "Seleccionaste una plataforma a la que no estás conectado. Conéctala primero en la sección Redes Sociales e inténtalo de nuevo.",
      ...
      seriesSetup: {
        ...
        summaryDays: "Días",
        tiktokPrivacyLabel: "Nivel de Privacidad de TikTok",
        tiktokPrivacyPlaceholder: "Selecciona nivel de privacidad...",
        tiktokPrivacyPublic: "Público para Todos",
        tiktokPrivacyMutualFollowers: "Seguidores Mutuos",
        tiktokPrivacyFollowers: "Solo Seguidores",
        tiktokPrivacyOnlyMe: "Solo Yo",
      },
      weekdays: {
        monday: "Lunes",
        tuesday: "Martes",
  ...
  fr: {
    ...
    steps: {
      ...
      chooseBackgroundVideo: "Choisir la Vidéo de Fond",
      chooseBackgroundVideoDesc: "Sélectionnez la vidéo de fond pour votre vidéo gameplay",
    ...
    categories: {
      ...
      "life-hacks": "Astuces de Vie",
      mystery: "Mystère",
      psychology: "Faits Psychologiques",
      "did-you-know": "Le Saviez-vous",
      animals: "Faits sur les Animaux",
      riddles: "Énigmes",
    },
    artStyles: {
    ...
    messages: {
      ...
      billingPortalError: "Échec de l'ouverture du portail de facturation. Veuillez réessayer.",
      seriesNameRequired: "Veuillez entrer un nom pour la série",
      selectOnePlatform: "Veuillez sélectionner au moins une plateforme de publication",
      tiktokPrivacyRequired: "Veuillez sélectionner un niveau de confidentialité TikTok pour continuer",
      starterPlanThreeDays: "Le plan Starter nécessite exactement 3 jours de publication par semaine.",
      eliteSecondPublishTime: "Veuillez sélectionner une deuxième heure de publication pour votre plan Elite.",
      seriesCreatedSuccess: "Série \"{{name}}\" créée avec succès !",
      noVideoToPost: "Aucune vidéo à publier",
      signInFirst: "Veuillez vous connecter d'abord",
      connectAccountFirst: "Veuillez connecter votre compte {{platform}} dans la section Réseaux sociaux",
      postingHandledAutomatically: "La publication sur {{platform}} est gérée automatiquement. Votre vidéo sera publiée à l'heure prévue.",
      socialConnectionVerifyFailed: "Échec de la vérification de la connexion aux réseaux sociaux",
      starterPlanDeselectDay: "Le plan Starter permet exactement 3 jours par semaine. Désélectionnez un autre jour d'abord.",
      connectionFailed: "Échec de la connexion",
      unknownError: "Erreur inconnue",
      oauthErrorFormat: "Erreur : {{error}}",
      oauthErrors: {
        missing_params: "Paramètres OAuth manquants",
        oauth_failed: "Échec de la connexion aux réseaux sociaux",
        access_denied: "Vous avez refusé l'accès",
        publish_scope_required: "Vous devez autoriser la permission de publication pour connecter. Réessayez et activez la publication lorsque demandé.",
      },
      cancel: "Annuler",
    },
    errors: {
    ...
    dashboard: {
      menu: {
        ...
        manageSeries: "Gérer les Séries",
        scheduledVideos: "Bibliothèque",
        subscription: "Mon Abonnement",
      },
      scheduledPosts: {
        title: "Bibliothèque",
        subtitle: "Consultez et gérez vos publications vidéo en attente.",
        loading: "Chargement des vidéos programmées...",
        empty: "Aucune vidéo programmée. Vos publications en attente apparaîtront ici.",
        download: "Télécharger",
        cancel: "Annuler",
        delete: "Supprimer",
        publishTime: "Heure de publication",
        platforms: "Plateformes",
        youtubeTitleLabel: "Titre",
        youtubeOnlyBadge: "YouTube uniquement",
        descriptionLabel: "Description",
        hashtagsLabel: "Hashtags",
        cancelConfirmTitle: "Annuler la publication programmée ?",
        cancelConfirmMessage: "Êtes-vous sûr de vouloir annuler cette publication programmée ? Cette action est irréversible.",
        ...
        publishSuccess: "Vidéo publiée avec succès !",
        publishFailed: "Échec de la publication de la vidéo",
        musicUsageConsentPrefix: "En publiant, vous acceptez la ",
        musicUsageConsentLink: "Confirmation d'Utilisation de la Musique de TikTok",
        musicUsageConsentSuffix: ".",
        processingNotice: "Après la publication, votre contenu peut prendre quelques minutes pour être traité et visible sur votre profil.",
        tiktokStatusUploading: "Envoi de la vidéo...",
        tiktokStatusUploadDesc: "Envoi de votre vidéo vers la plateforme. Cela peut prendre une minute...",
        tiktokStatusProcessing: "Publication sur TikTok...",
        tiktokStatusUpload: "Envoi de votre vidéo sur TikTok...",
        tiktokStatusDownload: "TikTok télécharge votre vidéo...",
        tiktokStatusInbox: "Vidéo envoyée dans votre boîte TikTok.",
        tiktokStatusWaiting: "En attente du traitement par TikTok...",
        tiktokStatusComplete: "Publié sur TikTok !",
        tiktokStatusCompleteDesc: "Votre vidéo est maintenant en ligne sur TikTok.",
        tiktokStatusFailed: "Échec de la publication",
        tiktokStatusFailedDesc: "Une erreur s'est produite lors de la publication de votre vidéo.",
        tiktokStatusFailedReason: "Raison",
        tiktokStatusDone: "Terminé",
        tiktokStatusClose: "Fermer",
      },
      subscription: {
      ...
      socialMedia: {
        ...
        disconnectErrorTitle: "Échec de la déconnexion de {platform}",
        connectSuccessTitle: "{platform} connecté",
        disconnectSuccessTitle: "{platform} déconnecté",
      ...
      seriesManagement: {
        ...
        never: "Jamais",
        platforms: "Plateformes",
        platformsHint: "Supprimer toutes les plateformes désactivera automatiquement la série.",
        videoType: "Type de Vidéo",
        ...
        errors: {
          ...
          CANNOT_ACTIVATE_WITHOUT_PLATFORMS: "Impossible d'activer une série sans plateformes. Ajoutez au moins une plateforme avant d'activer.",
          ...
          PLATFORM_NOT_CONNECTED: "Vous avez sélectionné une plateforme à laquelle vous n'êtes pas connecté. Connectez-la d'abord dans la section Réseaux sociaux, puis réessayez.",
      ...
      seriesSetup: {
        ...
        summaryDays: "Jours",
        tiktokPrivacyLabel: "Niveau de Confidentialité TikTok",
        tiktokPrivacyPlaceholder: "Sélectionnez le niveau de confidentialité...",
        tiktokPrivacyPublic: "Public pour Tous",
        tiktokPrivacyMutualFollowers: "Abonnés Mutuels",
        tiktokPrivacyFollowers: "Abonnés Uniquement",
        tiktokPrivacyOnlyMe: "Moi Uniquement",
      },
      weekdays: {
        monday: "Lundi",
        tuesday: "Mardi",
  ...
  pt: {
    ...
    steps: {
      ...
      chooseBackgroundVideo: "Escolher Vídeo de Fundo",
      chooseBackgroundVideoDesc: "Selecione o vídeo de fundo para seu vídeo de gameplay",
    ...
    categories: {
      ...
      "top-5": "Top 5",
      "fun-facts": "Fatos Curiosos",
      "life-hacks": "Dicas de Vida",
      mystery: "Mistério",
      psychology: "Fatos de Psicologia",
      "did-you-know": "Você Sabia",
      animals: "Fatos sobre Animais",
      riddles: "Enigmas",
    },
    artStyles: {
    ...
    messages: {
      ...
      billingPortalError: "Falha ao abrir o portal de cobrança. Por favor, tente novamente.",
      seriesNameRequired: "Por favor, digite um nome para a série",
      selectOnePlatform: "Por favor, selecione pelo menos uma plataforma de publicação",
      tiktokPrivacyRequired: "Por favor, selecione um nível de privacidade do TikTok para continuar",
      starterPlanThreeDays: "O plano Starter exige exatamente 3 dias de publicação por semana.",
      eliteSecondPublishTime: "Por favor, selecione um segundo horário de publicação para seu plano Elite.",
      seriesCreatedSuccess: "Série \"{{name}}\" criada com sucesso!",
      noVideoToPost: "Nenhum vídeo para publicar",
      signInFirst: "Por favor, faça login primeiro",
      connectAccountFirst: "Conecte sua conta {{platform}} primeiro na seção Redes Sociais",
      postingHandledAutomatically: "A publicação no {{platform}} é feita automaticamente. Seu vídeo será publicado no horário agendado.",
      socialConnectionVerifyFailed: "Falha ao verificar a conexão com redes sociais",
      starterPlanDeselectDay: "O plano Starter permite exatamente 3 dias por semana. Desmarque outro dia primeiro.",
      connectionFailed: "Falha na conexão",
      unknownError: "Erro desconhecido",
      oauthErrorFormat: "Erro: {{error}}",
      oauthErrors: {
        missing_params: "Parâmetros OAuth ausentes",
        oauth_failed: "Falha ao conectar às redes sociais",
        access_denied: "Você negou o acesso",
        publish_scope_required: "Você precisa permitir a permissão de publicar para conectar. Tente novamente e ative a publicação quando solicitado.",
      },
      cancel: "Cancelar",
    },
    errors: {
    ...
    dashboard: {
      ...
      scheduledPosts: {
        title: "Biblioteca",
        subtitle: "Veja e gerencie suas publicações de vídeo pendentes.",
        loading: "Carregando vídeos agendados...",
        empty: "Nenhum vídeo agendado. Suas publicações pendentes aparecerão aqui.",
        download: "Baixar",
        cancel: "Cancelar",
        delete: "Excluir",
        ...
        platforms: "Plataformas",
        youtubeTitleLabel: "Título",
        youtubeOnlyBadge: "Apenas YouTube",
        descriptionLabel: "Descrição",
        hashtagsLabel: "Hashtags",
        cancelConfirmTitle: "Cancelar publicação agendada?",
        cancelConfirmMessage: "Tem certeza de que deseja cancelar esta publicação agendada? Esta ação não pode ser desfeita.",
        ...
        publishing: "Publicando...",
        publishSuccess: "Vídeo publicado com sucesso!",
        publishFailed: "Falha ao publicar o vídeo",
        musicUsageConsentPrefix: "Ao publicar, você concorda com a ",
        musicUsageConsentLink: "Confirmação de Uso de Música do TikTok",
        musicUsageConsentSuffix: ".",
        processingNotice: "Após a publicação, seu conteúdo pode levar alguns minutos para ser processado e ficar visível no seu perfil.",
        tiktokStatusUploading: "Enviando vídeo...",
        tiktokStatusUploadDesc: "Enviando seu vídeo para a plataforma. Isso pode levar um minuto...",
        tiktokStatusProcessing: "Publicando no TikTok...",
        tiktokStatusUpload: "Enviando seu vídeo para o TikTok...",
        tiktokStatusDownload: "O TikTok está baixando seu vídeo...",
        tiktokStatusInbox: "Vídeo enviado para sua caixa de entrada do TikTok.",
        tiktokStatusWaiting: "Aguardando o TikTok processar...",
        tiktokStatusComplete: "Publicado no TikTok!",
        tiktokStatusCompleteDesc: "Seu vídeo já está disponível no TikTok.",
        tiktokStatusFailed: "Falha na publicação",
        tiktokStatusFailedDesc: "Ocorreu um erro ao publicar seu vídeo.",
        tiktokStatusFailedReason: "Motivo",
        tiktokStatusDone: "Concluído",
        tiktokStatusClose: "Fechar",
      },
      subscription: {
      ...
      socialMedia: {
        ...
        disconnectErrorTitle: "Falha ao desconectar do {platform}",
        connectSuccessTitle: "{platform} conectado",
        disconnectSuccessTitle: "{platform} desconectado",
      ...
      seriesManagement: {
        ...
        never: "Nunca",
        platforms: "Plataformas",
        platformsHint: "Remover todas as plataformas desativará automaticamente a série.",
        videoType: "Tipo de Vídeo",
        ...
        errors: {
          ...
          CANNOT_ACTIVATE_WITHOUT_PLATFORMS: "Não é possível ativar uma série sem plataformas. Adicione pelo menos uma plataforma antes de ativar.",
          ...
          PLATFORM_NOT_CONNECTED: "Você selecionou uma plataforma à qual não está conectado. Conecte-a primeiro na seção Redes Sociais e tente novamente.",
      ...
      seriesSetup: {
        ...
        summaryDays: "Dias",
        tiktokPrivacyLabel: "Nível de Privacidade do TikTok",
        tiktokPrivacyPlaceholder: "Selecione o nível de privacidade...",
        tiktokPrivacyPublic: "Público para Todos",
        tiktokPrivacyMutualFollowers: "Seguidores Mútuos",
        tiktokPrivacyFollowers: "Apenas Seguidores",
        tiktokPrivacyOnlyMe: "Apenas Eu",
      },
      weekdays: {
  ...
  de: {
    ...
    steps: {
      ...
      chooseBackgroundVideo: "Hintergrundvideo wählen",
      chooseBackgroundVideoDesc: "Wähle das Hintergrundvideo für dein Gameplay-Video",
    ...
    categories: {
      ...
      "life-hacks": "Lebenstipps",
      mystery: "Mysterium",
      psychology: "Psychologie-Fakten",
    ...
    messages: {
      ...
      billingPortalError: "Abrechnungsportal konnte nicht geöffnet werden. Bitte versuche es erneut.",
      seriesNameRequired: "Bitte gib einen Seriennamen ein",
      selectOnePlatform: "Bitte wähle mindestens eine Veröffentlichungsplattform",
      tiktokPrivacyRequired: "Bitte wähle ein TikTok-Datenschutzniveau aus, um fortzufahren",
      starterPlanThreeDays: "Der Starter-Plan erfordert genau 3 Veröffentlichungstage pro Woche.",
      eliteSecondPublishTime: "Bitte wähle eine zweite Veröffentlichungszeit für deinen Elite-Plan.",
      seriesCreatedSuccess: "Serie \"{{name}}\" erfolgreich erstellt!",
      noVideoToPost: "Kein Video zum Veröffentlichen",
      signInFirst: "Bitte melde dich zuerst an",
      connectAccountFirst: "Bitte verbinde zuerst dein {{platform}}-Konto im Bereich Soziale Medien",
      postingHandledAutomatically: "Die Veröffentlichung auf {{platform}} erfolgt automatisch. Dein Video wird zum geplanten Zeitpunkt veröffentlicht.",
      socialConnectionVerifyFailed: "Verbindung zu den sozialen Medien konnte nicht überprüft werden",
      starterPlanDeselectDay: "Der Starter-Plan erlaubt genau 3 Tage pro Woche. Bitte wähle zuerst einen anderen Tag ab.",
      connectionFailed: "Verbindung fehlgeschlagen",
      unknownError: "Unbekannter Fehler",
      oauthErrorFormat: "Fehler: {{error}}",
      oauthErrors: {
        missing_params: "OAuth-Parameter fehlen",
        oauth_failed: "Verbindung zu den sozialen Medien fehlgeschlagen",
        access_denied: "Du hast den Zugriff verweigert",
        publish_scope_required: "Du musst die Berechtigung zum Posten erteilen, um zu verbinden. Bitte versuche es erneut und aktiviere das Posten, wenn danach gefragt wird.",
      },
      cancel: "Abbrechen",
    },
    errors: {
    ...
    dashboard: {
      menu: {
        ...
        manageSeries: "Serien Verwalten",
        scheduledVideos: "Bibliothek",
        subscription: "Mein Abonnement",
      },
      scheduledPosts: {
        title: "Bibliothek",
        subtitle: "Geplante Video-Posts anzeigen und verwalten.",
        loading: "Geplante Videos werden geladen...",
        empty: "Keine geplanten Videos. Deine ausstehenden Posts erscheinen hier.",
        download: "Herunterladen",
        cancel: "Abbrechen",
        delete: "Löschen",
        publishTime: "Veröffentlichungszeit",
        platforms: "Plattformen",
        youtubeTitleLabel: "Titel",
        youtubeOnlyBadge: "Nur YouTube",
        descriptionLabel: "Beschreibung",
        hashtagsLabel: "Hashtags",
        cancelConfirmTitle: "Geplanten Post abbrechen?",
        cancelConfirmMessage: "Bist du sicher, dass du diesen geplanten Post abbrechen möchtest? Dies kann nicht rückgängig gemacht werden.",
        ...
        publishSuccess: "Video erfolgreich veröffentlicht!",
        publishFailed: "Veröffentlichung des Videos fehlgeschlagen",
        musicUsageConsentPrefix: "Mit der Veröffentlichung stimmen Sie der ",
        musicUsageConsentLink: "Musiknutzungsbestätigung von TikTok",
        musicUsageConsentSuffix: " zu.",
        processingNotice: "Nach der Veröffentlichung kann es einige Minuten dauern, bis Ihr Inhalt verarbeitet und auf Ihrem Profil sichtbar ist.",
        tiktokStatusUploading: "Video wird hochgeladen...",
        tiktokStatusUploadDesc: "Dein Video wird zur Plattform gesendet. Das kann eine Minute dauern...",
        tiktokStatusProcessing: "Wird auf TikTok veröffentlicht...",
        tiktokStatusUpload: "Dein Video wird zu TikTok hochgeladen...",
        tiktokStatusDownload: "TikTok lädt dein Video herunter...",
        tiktokStatusInbox: "Video wurde in deinen TikTok-Posteingang gesendet.",
        tiktokStatusWaiting: "Warte auf die Verarbeitung durch TikTok...",
        tiktokStatusComplete: "Auf TikTok veröffentlicht!",
        tiktokStatusCompleteDesc: "Dein Video ist jetzt auf TikTok live.",
        tiktokStatusFailed: "Veröffentlichung fehlgeschlagen",
        tiktokStatusFailedDesc: "Beim Veröffentlichen deines Videos ist ein Fehler aufgetreten.",
        tiktokStatusFailedReason: "Grund",
        tiktokStatusDone: "Fertig",
        tiktokStatusClose: "Schließen",
      },
      subscription: {
      ...
      socialMedia: {
        ...
        disconnectErrorTitle: "Fehler beim Trennen von {platform}",
        connectSuccessTitle: "{platform} verbunden",
        disconnectSuccessTitle: "{platform} getrennt",
      ...
      seriesManagement: {
        ...
        never: "Nie",
        platforms: "Plattformen",
        platformsHint: "Das Entfernen aller Plattformen deaktiviert die Serie automatisch.",
        videoType: "Videotyp",
        ...
        errors: {
          ...
          CANNOT_ACTIVATE_WITHOUT_PLATFORMS: "Eine Serie ohne Plattformen kann nicht aktiviert werden. Fügen Sie mindestens eine Plattform hinzu, bevor Sie aktivieren.",
          ...
          PLATFORM_NOT_CONNECTED: "Sie haben eine Plattform ausgewählt, mit der Sie nicht verbunden sind. Verbinden Sie sie zuerst im Bereich Soziale Medien und versuchen Sie es erneut.",
      ...
      seriesSetup: {
        ...
        summaryDays: "Tage",
        tiktokPrivacyLabel: "TikTok-Datenschutzniveau",
        tiktokPrivacyPlaceholder: "Datenschutzniveau auswählen...",
        tiktokPrivacyPublic: "Öffentlich für Alle",
        tiktokPrivacyMutualFollowers: "Gegenseitige Follower",
        tiktokPrivacyFollowers: "Nur Follower",
        tiktokPrivacyOnlyMe: "Nur Ich",
      },
      weekdays: {
        monday: "Montag",
        tuesday: "Dienstag",
